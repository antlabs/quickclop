...
OPTIONS:
    ...
    -h, --help      显示帮助信息
    -i, --int64    An int64 value (default: 42)
    --int64-ptr    An int64 pointer value (default: 100)
    --int64-slice    A slice of int64 values (default: 1,2,3)
    --int64-slice-ptr    A pointer to a slice of int64 values (default: 4,5,6)
