...
func (c *Config) Parse(args []string) error {
	...
	if envVal, ok := os.LookupEnv("APP_DEBUG"); ok {
	...
	if envVal, ok := os.LookupEnv("APP_PORT"); ok {
	...
	if envVal, ok := os.LookupEnv("APP_HOST"); ok {
		
		c.Host = envVal
		
	}
	
	if envVal, ok := os.LookupEnv("APP_LOG_LEVEL"); ok {
		
		c.LogLevel = envVal
		
	}
	
	if envVal, ok := os.LookupEnv("APP_DATA_DIR"); ok {
