...
OPTIONS:
    ...
    -h, --help      显示帮助信息
    -i, --int8    An int8 value (default: 42)
    --int8-ptr    An int8 pointer value (default: 100)
    --int8-slice    A slice of int8 values (default: 1,2,3)
    --int8-slice-ptr    A pointer to a slice of int8 values (default: 4,5,6)
