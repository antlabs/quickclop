...
func main() {
	...
	// Display all values
	fmt.Println("Int8 type with default value:")
	fmt.Printf("  Int8: %d\n", opts.Int8)

	fmt.Println("\nInt8 pointer type with default value:")
	if opts.Int8Ptr != nil {
	...
	fmt.Println("\nInt8 slice type with default value:")
	fmt.Printf("  Int8Slice: %v\n", opts.Int8Slice)

	fmt.Println("\nInt8 slice pointer type with default value:")
