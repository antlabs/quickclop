...
OPTIONS:
    ...
    -h, --help      显示帮助信息
    -u, --uint    A uint value (default: 42)
    --uint-ptr    A uint pointer value (default: 100)
    --uint-slice    A slice of uint values (default: 1,2,3)
    --uint-slice-ptr    A pointer to a slice of uint values (default: 4,5,6)
