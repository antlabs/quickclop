...
OPTIONS:
    ...
    -h, --help      显示帮助信息
    -i, --int    An int value (default: 42)
    --int-ptr    An int pointer value (default: 100)
    --int-slice    A slice of int values (default: 1,2,3)
    --int-slice-ptr    A pointer to a slice of int values (default: 4,5,6)
