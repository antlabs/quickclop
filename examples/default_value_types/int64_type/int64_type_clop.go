...
func (c *Options) Parse(args []string) error {
	...
	// 设置默认值
	for _, s := range strings.Split("1000000,2000000,3000000", ",") {
...
OPTIONS:
    ...
    -h, --help      显示帮助信息
    -i, --int64    An int64 value (default: 9876543210)
    --int64-ptr    An int64 pointer value (default: 1234567890)
    --int64-slice    A slice of int64 values (default: 1000000,2000000,3000000)
    --int64-slice-ptr    A pointer to a slice of int64 values (default: 4000000,5000000,6000000)
